...
def get_text_cosine_similarity(original_prompt: str, adversarial_prompt: str) -> float:
...
get_l2_similarity = get_text_cosine_similarity
...
if __name__ == "__main__":
    ...
    text_sim = get_text_cosine_similarity(original_prompt, adversarial_prompt)
    is_similar = text_sim > 0.6

    print(f"Semantic similarity: {'PASS' if is_similar else 'FAIL'}")
    print(f"Text cosine similarity: {text_sim}/1.0")
